...
export default function HomePage() {
  ...
  if (isLoading)
    return <DashboardLayout title="Products List">Loading...</DashboardLayout>;
  if (isError)
    return (
      <DashboardLayout title="Products List">
...
const ViewEditUpdateButton = () => {
  return (
    <div className="flex gap-3">
      <button className="flex items-center gap-1 rounded-md px-3 py-1 font-medium text-blue-700 transition hover:bg-blue-50">
        <FaEye />
        View
      </button>
      <button className="flex items-center gap-1 rounded-md px-3 py-1 font-medium text-orange-500 transition hover:bg-orange-50">
        <FaEdit />
        Update
      </button>
      <button className="flex items-center gap-1 rounded-md px-3 py-1 font-medium text-red-700 transition hover:bg-red-50">
        <FaTrash />
        Delete
      </button>
    </div>
